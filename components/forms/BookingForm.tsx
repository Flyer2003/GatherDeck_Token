            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-10">
                ...
                <section className="space-y-6 bg-[#1A1D21]/50 p-6 rounded-2xl border border-dark-400">
                    ...
                    <CustomFormField
                        ...
                        name="description"
                        label="Description *"
                        description="Describe your event in detail, including venue preferences, guest count, theme, budget expectations, special requirements, and any specific services you need."
                    />
